...
def main(_):
    ...
    with tf.Graph().as_default() as graph:
        ...
        class_loss, accuracy = MODEL(model_name, FLAGS.main_scope, weight_decay, image, label,
                                     ...
                                     hintLayerIndex=FLAGS.hintLayerIndex, guidedLayerIndex=FLAGS.guidedLayerIndex)
...
def MODEL(model_name, scope, weight_decay, image, label, is_training, reuse, drop, Distillation, hintLayerIndex,
          guidedLayerIndex):
    ...
    end_points = network_fn(image, label, scope, is_training=is_training, reuse=reuse, drop=drop, Distill=Distillation,
                            hintLayerIndex=hintLayerIndex, guidedLayerIndex=guidedLayerIndex)
